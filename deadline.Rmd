...
## Data Visualization - Graph Replication
...
![](/Users/sophiekersten/Desktop/data_visualisation/Rosetta-Stone-Learning-vs-Income_3448.png)
...
learningcurve <- read.csv("/Users/sophiekersten/Desktop/data_visualisation/learningcurve.csv")
...
```{r plot, echo=FALSE, fig.width=13, fig.height=9}
...
```{r graph2, echo=FALSE, fig.width=13, fig.height=9}
graph2 <- ggplot(all_results, aes(x = income_actual, y = mastertimss, color = country)) +
  geom_smooth(method = "loess", se = FALSE, span = 0.6, size = 0.3) +
  scale_color_manual(values = country_colors) +
  geom_text_repel(data = line_points, aes(x = label_x, y = label_y, label = country), size = 3) +
...
image_grob <- rasterGrob(
  png::readPNG("/Users/sophiekersten/Desktop/data_visualisation/Our_World_in_Data_logo.png"),
  x = 0.997, y = 0.992,  
  hjust = 1, vjust = 1, 
  width = unit(0.07, "npc"),  
...
```{r graph3, echo=FALSE, fig.width=14, fig.height=10}
graph3 <- ggplot(all_results, aes(x = income_actual, y = mastertimss, color = country)) +
  geom_smooth(method = "loess", se = FALSE, span = 0.6, size = 0.3) +
  scale_color_manual(values = country_colors) +
  geom_text_repel(data = line_points, aes(x = label_x, y = label_y, label = country), size = 3) +
...
```{r interactive_plot, echo=TRUE, fig.width=10, fig.height=7}
...
```{r p1, echo=TRUE, fig.width=12, fig.height=9}
...
```{r p2, echo=TRUE, fig.width=12, fig.height=9}
...
```{r p3, echo=TRUE, fig.width=12, fig.height=9}
...
```{r p4, echo=FALSE, fig.width=13, fig.height=9}
